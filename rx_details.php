...
echo $mode;
if($mode == "delete"){
    $sql = "DELETE from rx_item where visit_id=$visit_id  and clinic_id=$clinic_id";
    echo $sql;
    mysqli_query($conn, $sql) or die(mysqli_error($conn));

    header("location: rx_details.php");
}
                ...
                <div class="col-md-12">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <b style="color: steelblue;text-transform: capitalize">Prescription</b>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-bordered" id="dataTables-example">
                                        ...
                                        <tbody>
                                        <?php
    $sql = "SELECT a.visit_date,a.visit_id,b.mobile,b.full_name,b.card_no 
    from visit a,patients b where a.clinic_id=$clinic_id
    and a.patient_id=b.id  and visit_date>='$from_date' and visit_date<='$to_date'  
    and visit_date>='$from_date' and visit_date<='$to_date'
    and visit_id in (select visit_id from rx_item)  order by a.visit_id desc";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center" width="100">
                                                    <a onclick="show_rx(<?php echo $row['visit_id']; ?>)" class="btn
                                                    btn-info fa fa-print" title="Print" href="#"></a>
                                                    <a title="Delete Bill" class="btn btn-danger btn-info fa fa-trash-o"
                                                       onclick="delete_confirm(<?php echo $row['visit_id']; ?>)"
                                                       href="#"></a>
                                                </td>
                                            </tr>
                                            <?php
...
<script>
    ...
    function delete_confirm(visit_id){
        if(confirm("This bill will be deleted. Please confirm.")){
            window.location.href="rx_details.php?mode=delete&visit_id="+visit_id;
        }
    }
</script>
</body>
